  ...
  return (
    <div className="space-y-6">
      <div>
        ...
        <p className="text-muted-foreground mt-1">Administra la configuración y preferencias de tu cuenta.</p>
      </div>
            ...
            {tabs.map((tab) => (
              ...
              >
                <svg className="w-4 h-4" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                  ...
                  {tab.icon === "security" && (
                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 12l2 2 4-4m5.618-4.016A11.955 11.955 0 0112 2.944a11.955 11.955 0 01-8.618 3.04A12.02 12.02 0 002 12c0 6.083 3.39 11.741 8.382 12.869a11.955 11.955 0 01-8.382-3.04z" />
                  )}
                </svg>
                {tab.label}
              </button>
          ...
          {activeTab === "general" && (
            <div className="space-y-6">
              <div>
                ...
                <p className="text-muted-foreground text-sm">Configura las preferencias de tu cuenta.</p>
              </div>
            </div>
          )}
            ...
            <div className="space-y-6">
              ...
              <form onSubmit={handleSubmit} className="space-y-6 max-w-lg">
                <div className="space-y-2">
                  <Label htmlFor="currentPassword" className="text-primary text-xs font-semibold uppercase tracking-wider">
                    Contraseña Actual
                  </Label>
                ...
                <div className="space-y-2">
                  <Label htmlFor="newPassword" className="text-primary text-xs font-semibold uppercase tracking-wider">
                    Nueva Contraseña
                  </Label>
                  <div className="relative group">
                    <Input
                  ...
                  <div className="pt-2">
                    <div className="flex justify-between items-center mb-1.5">
                      <span className="text-[10px] font-bold text-muted-foreground uppercase tracking-widest">
                        Fortaleza:{" "}
                        <span className={strength === "strong" ? "text-secondary" : strength === "medium" ? "text-yellow-500" : "text-red-500"}>
                          {strength === "strong" ? "Fuerte" : strength === "medium" ? "Media" : "Débil"}
                        </span>
                      </span>
                      <span className="text-[10px] font-medium text-muted-foreground italic">mín 8 caracteres</span>
                    </div>
                    <div className="flex gap-1 h-1">
                      <div className={`flex-1 rounded-full ${strength === "weak" ? "bg-red-500" : strength === "medium" ? "bg-yellow-500" : "bg-green-500"}`} />
                      <div className={`flex-1 rounded-full ${strength === "weak" ? "bg-muted" : strength === "medium" ? "bg-yellow-500" : "bg-green-500"}`} />
                ...
                <div className="space-y-2">
                  <Label htmlFor="confirmPassword" className="text-primary text-xs font-semibold uppercase tracking-wider">
                  ...
                  {passwordsMatch && (
                    <p className="text-[10px] font-medium text-secondary pl-1">Las contraseñas coinciden</p>
                  )}
                </div>
          ...
          {activeTab === "security" && (
            <div className="space-y-6">
              <div>
                ...
                <p className="text-muted-foreground text-sm">Administra tu configuración de seguridad y 2FA.</p>
              </div>
            </div>
          )}
        </div>
